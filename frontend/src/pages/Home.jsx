    ...
    return (
      <div className="fixed inset-0 bg-black text-green-500 font-mono p-10 z-[100] flex flex-col justify-end">
        {terminalLines.map((line, i) => (
          <div key={i} className="text-sm md:text-base opacity-90">
            {line}
          </div>
        ))}
        ...
        <div className="section-container w-full grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 border border-primary-500/30 bg-primary-500/10 rounded-none backdrop-blur-md">
              ...
              <span className="font-mono text-xs text-primary-400 tracking-[0.2em] uppercase">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link
                to="/projects"
                className="relative overflow-hidden group px-8 py-4 bg-primary-600 font-bold text-white tracking-wider uppercase text-sm"
              >
                <span className="relative z-10 flex items-center gap-2">
                  Initialize Portfolio <FaArrowRight />
                </span>
                <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
              </Link>
              <Link
                to="/about"
                className="px-8 py-4 border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-white/30 transition-all font-mono text-sm uppercase tracking-wider text-gray-300"
              >
                Access Dossier
              </Link>
            </div>
          ...
          >
            ...
            <div className="relative z-10 w-80 h-[28rem] bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-2xl group transition-transform duration-500 hover:scale-[1.02]">
              ...
              <div className="absolute bottom-6 left-6 right-6 z-20">
                ...
                <h3 className="text-xl font-bold font-display mt-4 text-white">
                  Harsh Lad
                </h3>
        ...
        <div className="section-container">
          <div className="flex items-center gap-4 mb-16">
            ...
            <div className="flex items-center gap-2 px-4 py-2 border border-primary-500/30 bg-primary-500/10 rounded-full">
              ...
              <h2 className="font-mono text-sm text-primary-400 tracking-[0.2em] uppercase">
                System Architecture
              </h2>
            </div>
      ...
      <section className="py-32 bg-black/50 relative z-10">
        <div className="section-container">
          <div className="flex justify-between items-end mb-16">
            ...
            <Link
              to="/projects"
              className="hidden md:flex items-center gap-2 text-primary-400 hover:text-white transition-colors font-bold tracking-wider text-sm border-b border-primary-400/30 pb-1"
            >
        ...
        <div className="section-container relative z-20">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <a
              ...
              className="flex items-center justify-center gap-3 px-10 py-5 bg-white text-black font-bold text-lg hover:bg-primary-400 transition-all hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.2)]"
            >
            ...
            <a
              ...
              target="_blank"
              className="flex items-center justify-center gap-3 px-10 py-5 border border-white/20 text-white font-bold text-lg hover:bg-white/10 hover:border-white/40 transition-all"
            >
